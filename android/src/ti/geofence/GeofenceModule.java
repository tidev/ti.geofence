...
public class GeofenceModule extends KrollModule
{
    ...
    @Kroll.constant public static final int LOCATION_STATUS_ERROR = LocationStatusCodes.ERROR;
    @Kroll.constant public static final int LOCATION_STATUS_GEOFENCE_NOT_AVAILABLE = LocationStatusCodes.GEOFENCE_NOT_AVAILABLE;
    @Kroll.constant public static final int LOCATION_STATUS_GEOFENCE_TOO_MANY_GEOFENCES = LocationStatusCodes.GEOFENCE_TOO_MANY_GEOFENCES;
    @Kroll.constant public static final int LOCATION_STATUS_GEOFENCE_TOO_MANY_PENDING_INTENTS = LocationStatusCodes.GEOFENCE_TOO_MANY_PENDING_INTENTS;
    @Kroll.constant public static final int LOCATION_STATUS_SUCCESS = LocationStatusCodes.SUCCESS;
    ...
    public void startMonitoringForRegions(Object arg) {
        ...
        if (arg instanceof Object[]) {
            ...
            throw new IllegalArgumentException("Invalid argument type `" + arg.getClass().getName() + "` passed to startMonitoringForRegion()");
        }
