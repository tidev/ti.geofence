 ...
 *
 */
public class GeofenceRemover implements ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<Status>
{
			...
			case INTENT:
				try {
					...
					LocationServices.GeofencingApi
						.removeGeofences(mGoogleApiClient,
	...
	public void onResult(Status status)
	{
		...
		if (status.isSuccess()) {
			...
			broadcastIntent.putExtra(GeofenceUtils.EXTRA_GEOFENCE_STATUS, msg);
