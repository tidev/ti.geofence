...
public final class GeofenceUtils {
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "ti.geofence.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "ti.geofence.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "ti.geofence.EXTRA_GEOFENCE_STATUS";
    
    public static final String EXTRA_GEOFENCE_STATUS_CODE =
            "ti.geofence.EXTRA_GEOFENCE_STATUS_CODE";
    
    public static final String EXTRA_TRANSITION_TYPE =
            "ti.geofence.EXTRA_TRANSITION_TYPE";
    
    public static final String EXTRA_GEOFENCE_IDS =
            "ti.geofence.EXTRA_GEOFENCE_IDS";
