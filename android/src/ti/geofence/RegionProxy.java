...
public class RegionProxy extends KrollProxy
{
	...
	public void handleCreationDict(KrollDict params)
	{
		...
		transitionTypes = 0;
		if (!params.containsKey("notifyOnEntry")
			|| (params.containsKey("notifyOnEntry") && params.getBoolean("notifyOnEntry"))) {
			transitionTypes |= Geofence.GEOFENCE_TRANSITION_ENTER;
		}
		if (!params.containsKey("notifyOnExit")
			|| (params.containsKey("notifyOnExit") && params.getBoolean("notifyOnExit"))) {
