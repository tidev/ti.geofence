...
// 3. For iOS, add the following permission keys to the <ios> section of the tiapp.xml:
//
...
//
// 4. Run following curl commands from the terminal.
...
// 6. Follow one of the steps under the `Testing` section of the module's documentation for testing
